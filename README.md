    ...
    for i = 1,math.huge do game:GetService("RunService").RenderStepped:Wait()
        if _G.Magnet == true then
            for i2,v2 in pairs(game.Workspace.Enemies:GetChildren()) do
                if v2.Name == Ms and (v2.HumanoidRootPart.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 300 then
...
spawn(function()
    while wait(.5) do
        ...
        if _G.Dargon_Talon and game.Players.LocalPlayer:FindFirstChild("WeaponAssetCache") then
...
local page_Main = gui:tab{
    Icon = "http://www.roblov2.com/asset/?id=8991522929",
    Name = "Main"
}
local page_Combat = gui:tab{
    Icon = "http://www.roblov2.com/asset/?id=8991523689",
    Name = "Combat"
}
local page_Misc = gui:tab{
    Icon = "http://www.roblov2.com/asset/?id=8992112278",
    Name = "Misc"
}
...
page_Main:Toggle{
	Name = "Superhuman",
	StartingState = _G.Superhuman,
	Description = "Melee",
	Callback = function(state) _G.Superhuman = state end
}
if _G.Electric_Claw then
    
else
    _G.Electric_Claw = false
end
page_Main:Toggle{
	Name = "Electric Claw",
	StartingState = _G.Electric_Claw,
	Description = "Melee",
	Callback = function(state) _G.Electric_Claw = state end
}
if _G.Dragon_Talon then
    
else
    _G.Dragon_Talon = false
end
page_Main:Toggle{
	Name = "Dragon Talon",
	StartingState = _G.Dragon_Talon,
	Description = "Melee",
	Callback = function(state) _G.Dragon_Talon = state 
        local args = {
            [1] = "BlackbeardReward",
            [2] = "DragonClaw",
            [3] = "2"
...
page_Main:Toggle{
	Name = "Death Step",
	StartingState = _G.Death_Step,
	Description = "Melee",
	Callback = function(state) _G.Death_Step = state 
        local args = {
            [1] = "BuyBlackLeg"
        }
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args)) 
...
if _G.Sharkman_Karate then
    
else
    _G.Sharkman_Karate = false
end
page_Main:Toggle{
	Name = "Sharkman Karate",
	StartingState = _G.Sharkman_Karate,
	Description = "Melee",
	Callback = function(state) _G.Sharkman_Karate = state end
}
